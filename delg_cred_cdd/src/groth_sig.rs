...
impl Groth1Sig {
    pub fn new(
        ...
        impl_GrothSig_new!(messages, sk, setup_params.y, setup_params.g2, setup_params.g1, G1Vector)
    }
    ...
    pub fn verify_fast(
        ...
        for i in 0..messages.len() {
            ...
            // m_i * r, y_i * r, T_i * r
            temp.push(var_time_mul_scl_mul_with_same_field_element!(G1, r_vec[i + 1], table_m, table_y, table_T));
        }
...
impl Groth2Sig {
    pub fn new(
        ...
        impl_GrothSig_new!(messages, sk, setup_params.y, setup_params.g1, setup_params.g2, G2Vector)
    }
    ...
    pub fn verify_fast(
        ...
        for i in 0..messages.len() {
            // g1 * r, V * r, R * r
            temp.push(var_time_mul_scl_mul_with_same_field_element!(G1, r_vec[i + 1], table_g1, table_vk, table_R));
        }
